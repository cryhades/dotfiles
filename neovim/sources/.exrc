...
nmap   cs :colorscheme 
nmap  at :AirlineTheme 
nmap  wq :wq
nmap  q :q
nmap  w :w
nmap  nt :NERDTreeFind
nmap  b <Plug>(easymotion-s2)
nmap  mq :-1read $HOME/.vimsnips/mquery/.mquerie.html
nmap  m2 :-1read $HOME/.vimsnips/mquery/.mquerie1200.html
nmap  m1 :-1read $HOME/.vimsnips/mquery/.mquerie1024.html
nmap  m9 :-1read $HOME/.vimsnips/mquery/.mquerie900.html
nmap  m7 :-1read $HOME/.vimsnips/mquery/.mquerie768.html
nmap  m6 :-1read $HOME/.vimsnips/mquery/.mquerie600.html
nmap  m4 :-1read $HOME/.vimsnips/mquery/.mquerie480.html
nmap  m3 :-1read $HOME/.vimsnips/mquery/.mquerie320.html
nmap   no :-1read $HOME/.vimsnips/.normalize.html
nmap   st :-1read $HOME/.vimsnips/.css.html
nmap  ht :-1read $HOME/.vimsnips/.skeleton.html
...
inoremap <nowait> <silent> <expr>  coc#float#has_scroll() ? "\=coc#foat#scroll(1)\" : "\<Right>"
...
set ignorecase
set mouse=a
set packpath=~/vim,~/.config/nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/usr/share/nvim/runtime,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,/usr/share/vim/vimfiles,~/.vim/after
set runtimepath=~/vim,~/vim/plugged/indentLine,~/vim/plugged/i3-vim-syntax,~/vim/plugged/nerdtree,~/vim/plugged/vim-easymotion,~/vim/plugged/vim-tmux-navigator,~/vim/plugged/coc.nvim,~/vim/plugged/vim-airline,~/vim/plugged/vim-airline-themes,~/vim/plugged/vim-css-color,~/vim/plugged/vim-coloresque,~/vim/plugged/vim-surround,~/vim/plugged/vim-visual-multi,~/vim/plugged/vim-prettier,~/vim/plugged/gruvbox,~/vim/plugged/awesome-vim-colorschemes,~/vim/plugged/punchy.vim,~/vim/plugged/cyberpunk,~/.config/nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/usr/share/nvim/runtime,/usr/share/nvim/runtime/pack/dist/opt/matchit,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,~/.config/nvim/after,/usr/share/vim/vimfiles,~/vim/plugged/indentLine/after,~/vim/plugged/vim-css-color/after,~/vim/plugged/vim-coloresque/after,~/vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set shiftwidth=4
